...
def prediction_page():
    ...
    volatile_acidity = st.number_input("volatile_acidity", value=0.27)
    citric_acid = st.number_input("citric_acid", value=0.36)
    residual_sugar = st.number_input("residual_sugar", value=20.7)
    chlorides = st.number_input("chlorides", value=0.045)
    free_sulfur_dioxide = st.number_input("free_sulfur_dioxide", value=45.0)
    total_sulfur_dioxide = st.number_input("total_sulfur_dioxide", value=170.0)
